...
\subsection*{1. Where is this paper accepted?}

This paper is accepted by Empirical Software Engineering on Nov 5th, 2020. The amnuscipt ID is \#EMSE-D-19-00267R2. The link to the pre-print version is \url{https://arxiv.org/pdf/1911.02476.pdf}.

\subsection*{2. Is the Paper in Scope for ESEC/FSE?}

Yes. blablabla..

\subsection*{3. Is the Paper Part of Another JF Program?}

No.

\subsection*{4. Is the Paper Completely New/Novel?}
